/**
 * QR Code Generator for JavaScript - Keyless Auth Edition
 * Lightweight, GDPR-compliant QR code generation
 * Based on qrcode-generator by davidshimjs
 * Optimized for WordPress plugins
 *
 * @version 1.0.0
 * @license MIT
 */
...
(function(global) {
    ...
    QRCode.prototype = {
        ...
        createSvgTag: function(cellSize, margin, alt) {
            cellSize = cellSize || 2;
            margin = (typeof margin == 'undefined') ? cellSize * 4 : margin;
            alt = alt || "QR Code";
            ...
            for (var r = 0; r < this.getModuleCount(); r++) {
                for (var c = 0; c < this.getModuleCount(); c++) {
                    if (this.isDark(r, c)) {
                        svg += '<rect';
                        svg += ' x="' + (c * cellSize + margin) + '"';
                        svg += ' y="' + (r * cellSize + margin) + '"';
                        svg += ' width="' + cellSize + '"';
                        svg += ' height="' + cellSize + '"';
                        svg += ' fill="#000000"/>';
                    }
    ...
    // Public API - Create simple wrapper
    var qrcode = function(typeNumber, errorCorrectLevel) {
        ...
        qr.createSvgTag = function(cellSize, margin) {
            this.make();
            return QRCode.prototype.createSvgTag.call(this, cellSize, margin);
        };

        qr.createTableTag = function(cellSize, margin) {
            this.make();
            return QRCode.prototype.createTableTag.call(this, cellSize, margin);
        };
